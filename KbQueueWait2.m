function [secs,key]=KbQueueWait2(deviceIndex,MaxTime)
%  [secs,key]=KbQueueWait2([deviceIndex],MaxTime)
%
%  Waits for any key to be pressed and returns the time of the press.
%  key returns the button pressed. MaxTime (in seconds) indicates the 
%  experation time for the process to exit. 
%
